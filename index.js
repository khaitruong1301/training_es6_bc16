...
/*
    Spread operator: Dùng để sao chép giá trị của 1 object hoặc array (Reference value) 
    Các kiểu dữ liệu cơ sở (primitive value): number,string,boolean, undefine,null thì không cần sử dùng spread operator
*/

let sinhVien1 = {id:5, name:'Nguyễn văn A'};
let sinhVien2 = {...sinhVien1,address:'82 ung văn khiêm',name:'Trần Văn B'};
// sinhVien2.name = 'Trần Văn B';
...
//ES5
// let id = product123.id;
// let name = product123.name;
//ES6
...
let [idProduct,nameProduct,priceProduct,showInfoProduct] = productArray;
showInfoProduct();
console.log('Tên sản phẩm',nameProduct)

/*
    Object literal: Sử dụng tên biến để tạo ra tên thuộc tính đồng thời gán giá trị cho thuộc tính đó
*/

let tenSanPham = 'IphoneX';
let maSanPham = 'IP0001111';
...
/*
    Dynamic key: ES6 cho phép người dùng truyền động tên thuộc tính
    let myObject = {
        key: value
    }
*/
...
let product789 = {...product456,['price'] : 1000}
console.log('Tên sản phẩm',product456[nameID])
...
let arrProduct = [
    {id:1,name:'Galaxy note 9',price:1000}, //0
    {id:2,name:'Galaxy note 10',price:2000},//1
    {id:3,name:'Galaxy note 20',price:3000}, //2
]
//ES5
...
//ES6: for of: Mỗi lần duyệt lấy ra 1 item(phần tử) trong mảng
for(let prod of arrProduct) {
    console.log('prod',prod);
}
/*
    ES6: for in: Mỗi lần duyệt lấy ra index của phần tử trong mảng
    Đối object ta có thể duyệt các thuộc tính (key) bằng for in
*/
for (let index in arrProduct) {
    console.log(arrProduct[index],'prod');
}
...
console.log('id',product001.id);
console.log('name',product001.name);
console.log('price',product001.price);
...
let arrProductObject = {
    '00000xxxxx': {id:1,name:'Galaxy note 9',price:1000},
    '00000yyyyy':{id:2,name:'Galaxy note 10',price:2000},
    '00000zzzzz':{id:3,name:'Galaxy note 20',price:3000}
}

for(let key in arrProductObject) {
    console.log(key,arrProductObject[key])
}

// console.log(arrProductObject['00000xxxxx']) 